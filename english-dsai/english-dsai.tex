...
\section{Experience}
    \resumeSubHeadingListStart
        ...
        \resumeSubheading
        {Cloud Development Intern}{Dec 2024 -- Present}
        {Lorraine University}{Nancy, France}
            \resumeItemListStart
                \resumeItem{Conducting research on the design and implementation of a decentralized blockchain-based system for secure and efficient identity information sharing in cloud environments}
                \resumeItem{Developing a prototype of the proposed system using Hyperledger Indy, Kubernetes and AWS services}
                \resumeItem{Evaluating the performance and scalability of the system through extensive testing and analysis}
            \resumeItemListEnd

        \resumeSubheading
        {Full-Stack/Cloud Developer Intern}{Jan 2023 -- Jul 2023}
        ...
        {Ericsson}{Algiers, Algeria}
            \resumeItemListStart
                \resumeItem{Implemented image-recognition models using YOLO to assist field workers with device identification, achieving a classification accuracy of over 85\%}
