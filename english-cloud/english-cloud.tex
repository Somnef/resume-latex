       ...
       \resumeSubheading
        ...
        {Ericsson}{Algiers, Algeria}
            \resumeItemListStart
                ...
                \resumeItem{Built and trained a convolutional autoencoder for image denoising in PyTorch, which reached a 99\% reconstruction accuracy on the MNIST dataset}
        \resumeItemListEnd
        ...
        %         \resumeItem{Built web scrapers to automate data collection from company websites and showcased it on a VueJS dashboard}
        % \resumeItemListEnd
...
\section{Projects}
    \resumeSubHeadingListStart
        ...
        {\textbf{Auto-scaled AWS Infrastructure with Terraform} $|$ \emph{AWS, Terraform, Java}}{Jan. 2025}
            \resumeItemListStart
                \resumeItem{Designed JADE agents to DDoS a server, hosted on EC2 machines capable of spawning 20,000+ instances in under 30s}
                \resumeItem{Deployed a scalable infrastructure with Terraform to react to intense attacks by ensuring that CPU usage is always below 50\%}
        ...
        %     \resumeItemListStart
        %         \resumeItem{Developed own tool for GPU profiling, which ran in parallel neural networks training tasks with different hyper-parameters (number of neurons, learning rate, batch size... etc.) to explore the effect of each on energy consumption}
        %     \resumeItemListEnd
        ...
        %     \resumeItemListStart
        %         \resumeItem{Developed 1:1 replicas of popular games such as Flappy Bird and Snake using Pygame}
        ...
        %             \resumeItem{Simulated forest wildfire spread on the landscape through a semi-empirical cellular-automata model}
        %             \resumeItem{Winner of the Algerian Engineering Competition}
        %         \resumeItemListEnd
        ...
        %     \resumeItem{Winner of the Google DevFest 2021 Hackathon}
        %   \resumeItemListEnd
